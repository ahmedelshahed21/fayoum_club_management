...
import 'package:fayoum_club_management/core/widgets/empty_widget.dart';
...
class ActivitiesVerticalListViewSection extends StatelessWidget {
  ...
  const ActivitiesVerticalListViewSection({super.key, this.type});
      ...
      child: BlocBuilder<ActivitesCubit, ActivitesState>(
        builder: (context, state) {
          if (state is ActivitesLoading) {
           ...
           return ActivitesListView(activites: state.activitesModel.data);
